...
local DEFAULT_MISSING_ATTACHMENTS = 
...
function Hitbox:Recalibrate()
    ...
    if self.DebugLog then
        print(string.format('%s%s', DEFAULT_DEBUG_LOGGER_PREFIX, attachmentCount > 0 and string.format(DEFAULT_ATTACH_COUNT_NOTICE, attachmentCount, self.HitboxObject.Name) or string.format(DEFAULT_MISSING_ATTACHMENTS, self.HitboxObject.Name)))
    end
end
